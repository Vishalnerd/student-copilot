        ...
        <div key={chat._id} className="space-y-4 max-w-3xl mx-auto">
          ...
          {chat.question && (
            <div className="flex gap-4 items-start justify-end">
              {/* 💡 FIXED: Converted user background layer bubble to v4 dark parameters */}
          ...
          <div className="flex gap-4 items-start">
            ...
            {/* 💡 FIXED: Swapped light blue container out to handle soft dark gray slate nodes on inversion */}
            <div className="bg-blue-50/50 dark:bg-slate-800/40 border border-blue-100/80 dark:border-gray-800 rounded-2xl p-5 text-sm text-gray-800 dark:text-slate-200 leading-relaxed max-w-xl shadow-2xs relative group flex-1 transition-colors duration-200">
              {chat.answer === null ? (
                ...
                <div className="space-y-2 py-1 min-w-50">
                  <div className="h-4 bg-blue-200/40 dark:bg-slate-700/60 rounded-md w-full animate-pulse" />
                  <div className="h-4 bg-blue-200/40 dark:bg-slate-700/60 rounded-md w-5/6 animate-pulse" />
                  <div className="h-4 bg-blue-200/40 dark:bg-slate-700/60 rounded-md w-2/3 animate-pulse" />
                </div>
              ) : (
                /* Compiled Content Markdown Display Port */
                /* 💡 FIXED: Injected prose-invert for automated tailwind typographic dark conversion handling */
              ...
              {chat.answer !== null && (
                <div className="flex items-center gap-3 mt-4 pt-2.5 border-t border-blue-100/30 dark:border-gray-700/40 text-gray-400 dark:text-gray-500 text-xs">
                  <button
                    ...
                    className="flex items-center gap-1 hover:text-blue-600 dark:hover:text-blue-400 transition font-semibold cursor-pointer"
                  >
